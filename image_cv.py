...
if not pdf_files:
    ...
    for pdf_file in pdf_files:
        ...
        images = convert_from_path(pdf_path, size=(None, None), grayscale=False, output_folder=None, first_page=None, last_page=None, fmt="ppm", jpegopt=None, thread_count=1, userpw=None, use_cropbox=True, strict=False)
